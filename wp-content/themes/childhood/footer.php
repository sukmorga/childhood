<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <form action="#">
                    <?php echo do_shortcode('[contact-form-7 id="148" title="Форма вопроса"]') ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('insta', 2) ?>" class="footer__social-item" target="_blank">
                            ...
                            <a href="<?php the_field('faceb', 2) ?>" class="footer__social-item" target="_blank">
