...
?>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php the_field('toys_title_1') ?></h2>
                ...
                <h2 class="subtitle"><?php the_field('toys_title_2') ?></h2>
                <div class="toys__wrapper">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('question') ?></span> <?php the_field('call_to') ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contacts" id="contacts">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="title contacts__minititle"><?php the_field('phone_subtitle') ?></div>
                    ...
                    <div class="col-md-6">
                        <div class="title contacts__minititle"><?php the_field('form_subtitle') ?></div>
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="147" title="Форма отзывов"]') ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="title"><?php the_field('title_for_reviews') ?></div>
